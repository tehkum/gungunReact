...
export default function ProductManage(){
  ...
  return ( <div>
    <form  className="login-sec-2">
      ...
      <label>
        <textarea name="description1" value={formData.description1} onChange={handleChange} placeholder="Description 1"></textarea>
      </label>

      <label>
        <textarea name="description2" value={formData.description2} onChange={handleChange} placeholder="Description 2"></textarea>
      </label>
      ...
      <label>
        ...
        <input type="text" name="edition" value={formData.edition} onChange={handleChange} placeholder='Edition'/>
      </label>

      <label>
    
        <input type="text" name="numberOfPages" value={formData.numberOfPages} onChange={handleChange} placeholder='Number of pages'/>
      </label>
